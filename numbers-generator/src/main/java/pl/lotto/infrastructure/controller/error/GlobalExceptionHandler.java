...
class GlobalExceptionHandler {
    ...
    public final ResponseEntity<ApiError> handleException(Exception exception, WebRequest request) {
        ...
        if (exception instanceof WinningNumbersNotFoundException winningNumbersNotFoundException) {
    ...
    private ResponseEntity<ApiError> handleWinningNumbersNotFoundException(
            WinningNumbersNotFoundException exception, HttpHeaders headers, HttpStatus status, WebRequest request) {
