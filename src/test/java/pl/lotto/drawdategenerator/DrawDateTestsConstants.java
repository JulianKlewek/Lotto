...
public interface DrawDateTestsConstants {
    ...
    LocalDateTime secondFridayDraw = LocalDateTime.of(2024, Month.JUNE, 21, 20, 0);
    ...
    ZonedDateTime ticketCreatedAt3 = ZonedDateTime.of(2024, 6, 14, 19, 1, 0, 0, ZoneId.of("Europe/Warsaw"));
    ...
    static Stream<Arguments> VALID_NEXT_DRAW_DATES() {
        return Stream.of(
                ...
                Arguments.of(ticketCreatedAt2,
                        ZonedDateTime.of(firstFridayDraw, ZoneId.of("Europe/Warsaw"))),
                Arguments.of(ticketCreatedAt3,
                        ZonedDateTime.of(secondFridayDraw, ZoneId.of("Europe/Warsaw")))
        );
    }
